...
// Effect represents an effect that can be applied to a task.
type Effect struct {
	// Kind is the kind of effect to be applied.
	Kind string `mapstructure:"kind"`
	// MarkAsFailed is the effect to mark the task as failed.
	MarkAsFailed MarkAsFailed `mapstructure:"markAsFailed"`
	// Annotate is the effect to annotate the task.
...
// MarkAsFailed represents an effect that marks a task as failed.
type MarkAsFailed struct {
	// Message is the message to be used when marking the task as failed.
	Message string `mapstructure:"message"`
}

// Annotate represents an effect that annotates a task.
type Annotate struct {
	// Attributes are the attributes to be used when annotating the task.
